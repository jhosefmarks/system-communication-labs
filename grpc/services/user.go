...
type UserServiceServer interface {
	...
	AddUserVerbose(*pb.User, pb.UserService_AddUserVerboseServer) error
	AddUsers(pb.UserService_AddUsersServer) error
	AddUserStreamBoth(pb.UserService_AddUserStreamBothServer) error
